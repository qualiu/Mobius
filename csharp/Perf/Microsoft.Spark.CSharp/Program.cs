    ...
    class PerfBenchmark
    {
        ...
        public static void Main(string[] args)
        {
            if (args.Length < 1)
            {
                ...
                Console.WriteLine(@"Usage   : {0}  spark-local-dir          run-times  data-path", exe);
                Console.WriteLine(@"Example : {0}  D:\Temp\TempDirForSpark  10         hdfs:///perfdata/freebasedeletions/*", exe);
                Console.WriteLine(@"Example : {0}  D:\Temp\TempDirForSpark  1          hdfs:///perf/data/deletions/deletions.csv-00000-of-00020", exe);
                return;
            }
